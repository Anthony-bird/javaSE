package com.feng._03字节缓冲流的性能统计分析;
...
public class CopyDemo {
    public static final String SRC_FILE = "F:\\回忆\\1505526775961.jpg";
    public static final String DEST_FIlE = "F:\\";
    ...
    public static void copy01(){
        ...
        try(
                ...
                OutputStream os = new FileOutputStream(DEST_FIlE+"01.jpg");
        ){
            // 3.定义一个整型变量存储读取的字节。
            int ch ;
            while((ch = is.read())!=-1){
    ...
    public static void copy02(){
        ...
        try(
                ...
                InputStream is = new FileInputStream(SRC_FILE);
                // 2.创建一个低级的字节输出流管道与目标文件接通
                OutputStream os = new FileOutputStream(DEST_FIlE+"02.jpg");
        ){
            // 3.定义一个字节数组存储字节
    ...
    public static void copy03(){
        ...
        try(
                ...
                OutputStream os = new FileOutputStream(DEST_FIlE+"03.jpg");
    ...
    public static void copy04(){
        ...
        try(
                ...
                BufferedInputStream bis = new BufferedInputStream(is);
                // 2.创建一个敌机的字节输出流管道与目标文件接通
                OutputStream os = new FileOutputStream(DEST_FIlE+"04.jpg");
                BufferedOutputStream bos = new BufferedOutputStream(os);
        ){
            // 3.定义一个字节数组存储字节
            byte[] buffer = new byte[1024];
